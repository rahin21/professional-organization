...
function About() {
  return (
    <div className="flex justify-center">
      <div className="container mx-0 lg:mx-10 relative lg:flex  gap-16 my-20 md:mb-40  ">
        <div className="flex flex-col gap-5 lg:text-start text-center text-sm">
          ...
          <p>
            With years of experience in creating fresh spaces and redesigning
            home functionality, Gina Adair founded All Things In Place to bring
            specialized organization and assistance to the DFW-metroplex.
            lorem100{" "}
          </p>
